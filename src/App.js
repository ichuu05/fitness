          ...
          <form className="app__signup">
            <center>
              <img 
                ...
                height="40px;"
                src="https://firebasestorage.googleapis.com/v0/b/fitness-web-71c61.appspot.com/o/attachment_116306828.png?alt=media&token=5ad55a08-d73e-4034-81f2-ee55f732ad76"
                // "https://toogreen.ca/instagreen/img/instagreen.svg"
                alt=""
              />
            </center>
        ...
        <div style={modalStyle} className={classes.paper}>
          <form className="app__signup">
            ...
            <Input 
              ...
              onChange={(e) => setPassword(e.target.value)}
            />
            <Button id = "submit-signin" type="submit" onClick={signIn}>{lang ? "Connectez-vous":"Sign In"}</Button>
      ...
      <header className="app__header">
        ...
        <div className="app__loginContainer">
              ...
              <div className="loginLeft">
                { user ? (
                  <Button id= "logout-button" onClick={() => auth.signOut()}>{lang ? "Déconnecter":"Logout"}</Button>
                ) : (
      ...
      <footer className="footer">
        ...
        {user ? (
          ...
          <div className="footer__icons">
              ...
              <div className="footer__middle">
                  <Button id="signin" onClick={() => setOpenSignIn(true)}>
                    {lang ? "CONNEXION":"SIGN IN"} &nbsp;&nbsp;
                  </Button> 
                  <Button id="signup" onClick={() => setOpen(true)}>
